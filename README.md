...
This is a simple script to download all [VWG](http://www.linienverkehr.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"151145","Witterda, Breite Straﬂe",10.89151,51.036768,""
```
